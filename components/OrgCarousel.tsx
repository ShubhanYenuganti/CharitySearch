...
export default function OrgCarousel({ orgs }: OrgCarouselProps) {
  ...
  return (
    <div className="space-y-3">
      {/* Arrow controls — only shown when there are more cards than the window */}
      {orgs.length > VISIBLE && (
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            <button
              ...
              className="
                flex items-center justify-center w-8 h-8 rounded border border-border
